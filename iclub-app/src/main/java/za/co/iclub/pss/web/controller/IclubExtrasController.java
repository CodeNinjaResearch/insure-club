...
public class IclubExtrasController implements Serializable {
	...
	private static final String BASE_URL = BUNDLE.getString("ws.protocol") + BUNDLE.getString("ws.host") + ":" + BUNDLE.getString("ws.port") + BUNDLE.getString("ws.context") + "/iclub/IclubExtrasService/";
	...
	public List<IclubExtrasBean> getDashBoardBeans() {
		...
		if (models != null && models.size() > 0) {
			for (IclubExtrasModel model : models) {
				...
				IclubExtrasBean bean = IclubExtrasTrans.fromWStoUI(model);
