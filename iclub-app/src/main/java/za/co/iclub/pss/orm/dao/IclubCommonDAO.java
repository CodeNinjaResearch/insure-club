...
public class IclubCommonDAO {
	...
	public List findAllLookValuesByTabelName(String tableName) {
		...
		try {
			...
			String query = "select t." + colShrtNm + "_id, t." + colShrtNm
					+ "_short_desc,t." + colShrtNm + "_long_desc from "
					+ tableName + " t";
	...
	public String findAllLookValuesByTabelName(String tableName, String id) {
		...
		try {
			...
			String query = "select t." + colShrtNm + "_id, t." + colShrtNm
					+ "_short_desc,t." + colShrtNm + "_long_desc from "
					+ tableName + " t where " + colShrtNm + "_id=" + id;
			Query queryObject = getCurrentSession().createSQLQuery(query);
	...
	public Object getFieldValueByFieldNameAndId(String fieldName,
			String tableName, String recordId) {

		try {
			String colShrtNm = getColumFormat(tableName);
			String query = "select  " + fieldName + " from " + tableName
					+ " where " + colShrtNm + "_id like " + "'" + recordId
					+ "'";
	...
	public Object[] getFieldValuesByFieldNameAndId(String fieldName,
			String tableName, String recordId) {

		try {
			String colShrtNm = getColumFormat(tableName);
			String query = "select  " + fieldName + "lat ," + fieldName
					+ "long" + " from " + tableName + " where " + colShrtNm
					+ "_id like " + "'" + recordId + "'";
