 ...
 * IclubTrackerMaster entities. Transaction control of the save(), update() and
 * delete() operations can directly support Spring container-managed
 * transactions or they can be augmented to handle user-managed Spring
 * transactions. Each of these methods provides additional information for how
 * to configure it for the desired type of transaction control.
 * 
 * @see za.co.iclub.pss.orm.bean.IclubTrackerMaster
 * @author MyEclipse Persistence Tools
 */
@Transactional
@SuppressWarnings({ "unchecked", "rawtypes" })
public class IclubTrackerMasterDAO {
	private static final Logger log = LoggerFactory.getLogger(IclubTrackerMasterDAO.class);
	// property constants
	public static final String TM_NAME = "tmName";
	public static final String TM_TRADE_NAME = "tmTradeName";
	public static final String TM_LOCATION = "tmLocation";
	...
	public List findAll() {
		...
		try {
			String queryString = "from IclubTrackerMaster";
			Query queryObject = getCurrentSession().createQuery(queryString);
			return queryObject.list();
		} catch (RuntimeException re) {
