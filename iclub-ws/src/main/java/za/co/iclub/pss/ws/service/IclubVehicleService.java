...
public class IclubVehicleService {
	...
	private IclubVehUsageTypeDAO iclubPurposeTypeDAO;
	...
	public ResponseModel add(IclubVehicleModel model) {
		try {
			...
			iCV.setIclubVehUsageType(model.getIclubVehUsageType() != null ? iclubPurposeTypeDAO.findById(model.getIclubVehUsageType()) : null);
		...
		try {
			...
			if (batmod != null && batmod.size() > 0) {
				for (Object object : batmod) {
					...
					model.setIclubVehUsageType(iCV.getIclubVehUsageType() != null ? (iCV.getIclubVehUsageType().getVuId()) : null);
	...
	public IclubVehicleModel getModelFromBean(IclubVehicle bean) {
		...
		model.setIclubVehUsageType(bean.getIclubVehUsageType() != null ? (bean.getIclubVehUsageType().getVuId()) : null);
	...
	public void setIclubVehUsageTypeDAO(IclubVehUsageTypeDAO iclubPurposeTypeDAO) {
