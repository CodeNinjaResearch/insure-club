...
@NamedNativeQueries({ @NamedNativeQuery(query = "select * from iclub_account where a_crtd_by=:id", name = "getIclubAccountByUser", resultClass = IclubAccount.class),
        ...
        @NamedNativeQuery(query = "select * from iclub_policy where p_status_id=:policyStatus order by p_crtd_dt asc", name = "getIclubPolicyByPolicyStatus", resultClass = IclubPolicy.class),
