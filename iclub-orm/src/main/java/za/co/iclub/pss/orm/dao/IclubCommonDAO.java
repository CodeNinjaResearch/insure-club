...
public class IclubCommonDAO {
	...
	public Object[] getFieldValuesByFieldNameAndId(String fieldName, String tableName, String recordId) {
		
		try {
			String colShrtNm = getColumFormat(tableName);
			String query = "select  " + fieldName + "lat ," + fieldName + "long" + " from " + tableName + " where " + colShrtNm + "_id like " + "'" + recordId + "'";
