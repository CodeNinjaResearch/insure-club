...
CREATE TABLE `iclub_account` (
  ...
  `a_crtd_dt` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `iclub_bank_master` (
  ...
  `bm_branch_lat` decimal(10,0) DEFAULT NULL,
  `bm_branch_long` decimal(10,0) DEFAULT NULL,
  `bm_branch_zip` int(5) DEFAULT NULL,
  `bm_crtd_dt` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `iclub_claim_item` (
  ...
  `ci_value` decimal(10,0) DEFAULT NULL,
  ...
  `ci_crtd_dt` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`ci_id`),
...
CREATE TABLE `iclub_country_code` (
  ...
  `cc_crtd_dt` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `iclub_cover_type` (
  ...
  `ct_crtd_dt` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`ct_id`),
...
CREATE TABLE `iclub_document` (
  ...
  `d_crtd_dt` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`d_id`),
...
CREATE TABLE `iclub_driver` (
  ...
  `d_issue_dt` timestamp NULL DEFAULT NULL,
  `d_person_id` varchar(36) COLLATE utf8_bin DEFAULT NULL,
  `d_dob` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `iclub_event` (
  ...
  `e_crtd_dt` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`e_id`),
...
CREATE TABLE `iclub_geo_loc` (
  ...
  `gl_lat` decimal(10,0) DEFAULT NULL,
  `gl_long` decimal(10,0) DEFAULT NULL,
  `gl_rate` decimal(10,0) DEFAULT NULL,
  `gl_crtd_dt` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `iclub_insurance_item` (
  ...
  `ii_crtd_dt` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`ii_id`),
...
CREATE TABLE `iclub_insurer_master` (
  ...
  `im_lat` decimal(10,0) DEFAULT NULL,
  `im_long` decimal(10,0) DEFAULT NULL,
  `im_reg_num` varchar(25) COLLATE utf8_bin DEFAULT NULL,
  `im_crtd_dt` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `iclub_license_code` (
  ...
  `lc_crtd_dt` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`lc_id`),
...
CREATE TABLE `iclub_mb_comment` (
  ...
  `mbc_crtd_dt` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`mbc_id`),
...
CREATE TABLE `iclub_message` (
  ...
  `m_sent_dt` timestamp NULL DEFAULT NULL,
  ...
  `m_crtd_dt` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`m_id`),
...
CREATE TABLE `iclub_message_board` (
  ...
  `mb_crtd_dt` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`mb_id`),
...
CREATE TABLE `iclub_notif` (
  ...
  `n_crtd_dt` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`n_id`),
...
CREATE TABLE `iclub_occupation` (
  ...
  `o_crtd_dt` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`o_id`),
...
CREATE TABLE `iclub_person` (
  ...
  `p_lat` decimal(10,0) DEFAULT NULL,
  `p_long` decimal(10,0) DEFAULT NULL,
...
CREATE TABLE `iclub_policy` (
  ...
  `p_premium` decimal(10,0) DEFAULT NULL,
  `p_prorata_prm` decimal(10,0) DEFAULT NULL,
...
CREATE TABLE `iclub_property` (
  ...
  `p_est_value` decimal(10,0) DEFAULT NULL,
  `p_crtd_by` varchar(36) COLLATE utf8_bin DEFAULT NULL,
  `p_crtd_dt` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`p_id`),
...
CREATE TABLE `iclub_purpose_type` (
  ...
  `pt_crtd_dt` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`pt_id`),
...
CREATE TABLE `iclub_quote` (
  ...
  `q_crtd_dt` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`q_id`),
...
CREATE TABLE `iclub_rate_type` (
  ...
  `rt_crtd_dt` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`rt_id`),
...
CREATE TABLE `iclub_security_device` (
  ...
  `sd_crtd_dt` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`sd_id`),
...
CREATE TABLE `iclub_security_master` (
  ...
  `sm_crtd_dt` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `iclub_suppl_master` (
  ...
  `sm_lat` decimal(10,0) DEFAULT NULL,
  `sm_long` decimal(10,0) DEFAULT NULL,
  `sm_cr_limit` decimal(10,0) DEFAULT NULL,
...
CREATE TABLE `iclub_tracker_master` (
  ...
  `tm_lat` decimal(10,0) DEFAULT NULL,
  `tm_long` decimal(10,0) DEFAULT NULL,
  `tm_reg_num` varchar(25) COLLATE utf8_bin DEFAULT NULL,
  `tm_crtd_dt` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `iclub_vehicle` (
  ...
  `v_on_lat` decimal(10,0) DEFAULT NULL,
  `v_on_long` decimal(10,0) DEFAULT NULL,
  `v_on_access_type_id` bigint(20) DEFAULT NULL,
  `v_dd_area` varchar(999) COLLATE utf8_bin DEFAULT NULL,
  `v_dd_lat` decimal(10,0) DEFAULT NULL,
  `v_dd_long` decimal(10,0) DEFAULT NULL,
  `v_dd_access_type_id` bigint(20) DEFAULT NULL,
  `v_year` int(4) DEFAULT NULL,
  `v_driver_id` varchar(36) COLLATE utf8_bin DEFAULT NULL,
  `v_insured_value` decimal(10,0) DEFAULT NULL,
  `v_concess_prct` decimal(10,0) DEFAULT NULL,
  ...
  `v_crtd_dt` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`v_id`),
...
CREATE TABLE `iclub_vehicle_master` (
  ...
  `vm_orig_rate` decimal(10,0) DEFAULT NULL,
  `vm_mrkt_rate` decimal(10,0) DEFAULT NULL,
  `vm_ret_rate` decimal(10,0) DEFAULT NULL,
  `vm_prod_dt` date DEFAULT NULL,
  `vm_crtd_dt` timestamp NULL DEFAULT NULL,
